...
const texDiffuse = textureLoader.load("/textures/weathered_planks_diff_1k.jpg");
texDiffuse.wrapS = texDiffuse.wrapT = THREE.RepeatWrapping;
texDiffuse.minFilter = THREE.LinearFilter
const texNormal = textureLoader.load("/textures/weathered_planks_nor_gl_1k.jpg");
texNormal.wrapS = texNormal.wrapT = THREE.RepeatWrapping;
texNormal.minFilter = THREE.LinearFilter
const texAo = textureLoader.load("/textures/weathered_planks_rough_1k.jpg");
texAo.wrapS = texAo.wrapT = THREE.RepeatWrapping;
texAo.minFilter = THREE.LinearFilter
...
gui.add(uniforms.uWarpStrength, "value", 0, 1, 0.001).name("uPositionFrequency");
