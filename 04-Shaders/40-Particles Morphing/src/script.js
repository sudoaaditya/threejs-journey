...
gltfLoader.load('/models.glb', (gltf) => {
    ...
    const randomSizes = new Float32Array(particles.maxCount);
    ...
    particles.geometry.setAttribute("aSize", new THREE.Float32BufferAttribute(randomSizes, 1));

    // mat properties
    particles.minColor = "#f6d388"; // "#ff7300"
    particles.maxColor = "#041af3"; // "#0091ff"
    ...
    particles.material = new THREE.ShaderMaterial({
        ...
        uniforms:
        {
            ...
            uMinColor: new THREE.Uniform(new THREE.Color(particles.minColor)),
            uMaxColor: new THREE.Uniform(new THREE.Color(particles.maxColor)),
        },
        // transparent: true,
    ...
    gui
        .addColor(particles, "minColor")
        .onChange(() => {
            particles.material.uniforms.uMinColor.value.set(particles.minColor)
        })

    gui
        .addColor(particles, "maxColor")
        .onChange(() => {
            particles.material.uniforms.uMaxColor.value.set(particles.maxColor)
        })
